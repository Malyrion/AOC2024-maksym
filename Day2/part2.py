    ...
    for line in file:
        ...
        for i in range(1,len(array2)):
            if(array2[0]-array2[1]>0):
                ...
                if(array2[0]-array2[2]>0):
                    descend=True
                elif(array2[0]-array2[2]<0):
                    descend=False
                else:
                    count-=1
                    break
            if(array2[i-1]-array2[i]==0 or array2[i-1]-array2[i]>3 or array2[i-1]-array2[i]<0 and descend==True):
                ...
                if(array2[i-2]-array2[i]==0 or array2[i-2]-array2[i]>3 or array2[i-2]-array2[i]<0 and descend==True or array2[i-2]-array2[i-1]==0 or array2[i-2]-array2[i-1]>3 or array2[i-2]-array2[i-1]<0 and descend==True):
                    print("removing",array2[i-1])
                    print(array2[i-2])
                    print(array2[i])
                    print(array2[i-2]-array2[i])
                    count-=1
                    break
                print("removing is solving",array2[i-1])
                print(array2[i-2])
                print(array2[i])
                print(array2[i-2]-array2[i])
            if(array2[i-1]-array2[i]==0 or array2[i-1]-array2[i]<-3 or array2[i-1]-array2[i]>0 and descend==False):
                ...
                print(array2[i])
                print(array2[i-1]-array2[i])
                if(array2[i-2]-array2[i]==0 or array2[i-2]-array2[i]<-3 or array2[i-2]-array2[i]>0 and descend==False or array2[i-2]-array2[i-1]==0 or array2[i-2]-array2[i-1]<-3 or array2[i-2]-array2[i-1]>0 and descend==False):
                    print("removing",array2[i-1])
                    print(array2[i-2])
                    print(array2[i])
                    print(array2[i-2]-array2[i])
                    print(" or removing",array2[i])
                    print(array2[i-2])
                    print(array2[i-1])
                    print(array2[i-2]-array2[i-1])
                    count-=1
                    break
                print("removing is solving",array2[i-1])
                print(array2[i-2])
